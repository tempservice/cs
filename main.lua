if getgenv().Loaded == nil then
	...
	local SpamChat = function()
		pcall(function()
			game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync(CONFIG_MESSAGE2)
		end)
		...
		pcall(function()
			game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync(CONFIG_MESSAGE3)
		end)
	end

	local ServerHop = function()
		queue = queue .. " getgenv().CONFIG_MESSAGE1 = `" ..CONFIG_MESSAGE1 .. "`"
		queue = queue .. " getgenv().CONFIG_MESSAGE2 = `" ..CONFIG_MESSAGE2 .. "`"
		queue = queue .. " getgenv().CONFIG_MESSAGE3 = `" ..CONFIG_MESSAGE3 .. "`"
